...
const API_BASE = "https://bpwindonesia-be-dot-h-02-451302.et.r.appspot.com/api";
    ...
    <div className="min-h-screen flex bg-gray-50">
      <aside className="w-64 bg-white shadow-md h-full p-6">
        ...
        <nav className="flex flex-col gap-4">
          <button
            ...
            className={`text-left font-medium px-4 py-2 rounded ${
              activeTab === "blog" ? "bg-[#FEF5F5] text-[#84281B]" : "text-gray-700 hover:bg-gray-100"
            }`}
          >
            Blog
          </button>
          <button
            ...
            className={`text-left font-medium px-4 py-2 rounded ${
              activeTab === "event" ? "bg-[#FEF5F5] text-[#84281B]" : "text-gray-700 hover:bg-gray-100"
            }`}
          >
            Event
          </button>
      ...
      <main className="flex-1 p-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={() => openModal()} className="bg-[#84281B] text-white px-4 py-2 rounded hover:bg-[#a03a2a]">
            ...
            <tbody>
              {list.map((item) => (
                <tr key={item._id} className="border-t">
                  ...
                  <td className="py-2">
                    <button onClick={() => openModal(item)} className="text-blue-600 hover:underline mr-4">
                      Edit
                    </button>
                    <button onClick={() => handleDelete(item.id, activeTab)} className="text-red-600 hover:underline">
                      Hapus
                    </button>
                  </td>
                </tr>
            ...
            <div className="bg-white w-full max-w-lg p-6 rounded-lg shadow-lg relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button type="submit" className="px-4 py-2 rounded bg-[#84281B] text-white">
                    Simpan
                  </button>
                </div>
              </form>
